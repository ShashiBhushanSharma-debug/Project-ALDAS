...
#include "px4_msgs/msg/detail/setpoint_config__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4_msgs::msg::SetpointConfig;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4_msgs::msg::SetpointConfig *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4_msgs::msg::SetpointConfig *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetpointConfig__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const px4_msgs::msg::SetpointConfig *>(
...
static size_t _SetpointConfig__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetpointConfig(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SetpointConfig__callbacks = {
  "px4_msgs::msg",
  "SetpointConfig",
...
static rosidl_message_type_support_t _SetpointConfig__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetpointConfig__callbacks,
...
{
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_SetpointConfig__handle;
}
