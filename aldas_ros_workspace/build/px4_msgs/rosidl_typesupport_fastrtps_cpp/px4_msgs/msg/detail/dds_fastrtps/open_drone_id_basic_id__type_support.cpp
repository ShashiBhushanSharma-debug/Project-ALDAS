...
#include "px4_msgs/msg/detail/open_drone_id_basic_id__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4_msgs::msg::OpenDroneIdBasicId;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4_msgs::msg::OpenDroneIdBasicId *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4_msgs::msg::OpenDroneIdBasicId *>(
    untyped_ros_message);
...
{
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_OpenDroneIdBasicId__handle;
}
