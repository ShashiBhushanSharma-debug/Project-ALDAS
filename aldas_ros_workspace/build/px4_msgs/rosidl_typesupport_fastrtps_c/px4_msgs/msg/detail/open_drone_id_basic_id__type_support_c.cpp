...
#include "px4_msgs/msg/detail/open_drone_id_basic_id__rosidl_typesupport_fastrtps_c.h"
...
using _OpenDroneIdBasicId__ros_msg_type = px4_msgs__msg__OpenDroneIdBasicId;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4_msgs__msg__OpenDroneIdBasicId;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const px4_msgs__msg__OpenDroneIdBasicId * ros_message = static_cast<const px4_msgs__msg__OpenDroneIdBasicId *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_px4_msgs__msg__OpenDroneIdBasicId(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  px4_msgs__msg__OpenDroneIdBasicId * ros_message = static_cast<px4_msgs__msg__OpenDroneIdBasicId *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_px4_msgs__msg__OpenDroneIdBasicId(cdr, ros_message);
}

static uint32_t _OpenDroneIdBasicId__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4_msgs__msg__OpenDroneIdBasicId(
...
static size_t _OpenDroneIdBasicId__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_px4_msgs__msg__OpenDroneIdBasicId(
