  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: pid_idle_rpm_integral
  {
    cdr << ros_message->pid_idle_rpm_integral;
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: substate
  {
    size_t item_size = sizeof(ros_message->substate);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  // Field name: pid_idle_rpm_integral
  {
    size_t item_size = sizeof(ros_message->pid_idle_rpm_integral);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    is_plain =
      (
      offsetof(DataType, pid_idle_rpm_integral) +
      last_member_size
      ) == ret_val;
  }
  return ret_val;
